...
import { ListDoctorsDto } from '@/core/application/dtos/list-doctors.dto';
...
export class DoctorController {
  ...
  @ApiOperation({ summary: 'Listar médicos com paginação e filtros' })
  ...
  listAll(@Query() query: ListDoctorsDto) {
